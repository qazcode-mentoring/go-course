...
func main() {
	...
	names := []string{"Али13са", "Боб", "Чарли", "Дэйв", "Ева"}
	...
	// Ответ: это происходит из-за конкурентности выполнения горутин и планировщика Go.
	// Планировщик может запускать горутины в разном порядке
}
